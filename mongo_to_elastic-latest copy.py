...
# AWS 
MONGO_HOST = "cluster0.mmmbecv.mongodb.net" 
MONGO_DB = "realestate"
MONGO_USER = "realestate"
MONGO_PASS = "realestate"

#uri = "mongodb://{}/{}".format(MONGO_HOST,MONGO_DB)
uri = "mongodb+srv://realestate:realestate@cluster0.mmmbecv.mongodb.net/?retryWrites=true&w=majority"
Client = MongoClient()

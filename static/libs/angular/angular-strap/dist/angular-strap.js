        ...
        function ($window, $rootScope, $tooltip, $$rAF, $timeout) {
          ...
          function TypeaheadFactory(element, controller, config) {
            ...
            $typeahead.$onKeyDown = function (evt) {
              ...
              if (
                $typeahead.$isVisible() &&
                !(evt.keyCode === 13 && scope.$activeIndex === -1)
              ) {
                evt.preventDefault();
                evt.stopPropagation();
              }
            ...
            $typeahead.show = function () {
              ...
              $timeout(
                function () {
                  $typeahead.$element &&
                    $typeahead.$element.on(
                      "mousedown",
                      $typeahead.$onMouseDown
                    );
                  if (options.keyboard) {
        ...
        return {
          ...
          link: function postLink(scope, element, attr, controller) {
            ...
            controller.$render = function () {
              ...
              selected = angular.isObject(selected)
                ? parsedOptions.displayValue(selected)
                : selected;
              var value = selected
        ...
        function (
          ...
          function TooltipFactory(element, config) {
            ...
            $tooltip.show = function () {
              ...
              tipElement = $tooltip.$element = compileData.link(
                tipScope,
            ...
            $tooltip.$applyPlacement = function () {
              ...
              if (autoPlace) {
                ...
                if (
                  originalPlacement.indexOf("bottom") >= 0 &&
                  elementPosition.bottom + tipHeight > viewportPosition.bottom
                ) {
                  placement = originalPlacement.replace("bottom", "top");
                } else if (
                  originalPlacement.indexOf("top") >= 0 &&
            ...
            function applyPlacement(offset, placement) {
              ...
              if (/top|right|bottom|left/.test(placement)) {
                var isVertical = /top|bottom/.test(placement),
                  ...
                  arrowOffsetPosition = isVertical
                    ? "offsetWidth"
                    : "offsetHeight";
            ...
            function getViewportAdjustedDelta(
              ...
              if (/right|left/.test(placement)) {
                ...
                var rightEdgeOffset =
                  position.left + viewportPadding + actualWidth;
      ...
      this.$get = [
        ...
        function (
          ...
          function timepickerFactory(element, controller, config) {
            ...
            var selectedIndex = 0;
            var defaultDate = options.roundDisplay
              ? floorMinutes(new Date())
              : new Date();
            ...
            var format = $dateFormatter.getDatetimeFormat(
              options.timeFormat,
              lang
            );
            ...
            $timepicker.$build = function () {
              ...
              for (i = 0; i < options.length; i++) {
                second = new Date(
                  ...
                  0,
                  0,
                  viewDate.second - (midIndex - i) * options.secondStep
                );
                seconds.push({
                  date: second,
                  label: formatDate(second, secondsFormat),
                  selected:
                    $timepicker.$date && $timepicker.$isSelected(second, 2),
            ...
            $timepicker.$isDisabled = function (date, index) {
              ...
              if (index === 0) {
                ...
                selectedTime =
                  date.getTime() + viewDate.hour * 36e5 + viewDate.second * 1e3;
              } else if (index === 2) {
                selectedTime =
                  date.getTime() + viewDate.hour * 36e5 + viewDate.minute * 6e4;
              }
              return (
            ...
            $timepicker.$setTimeByStep = function (value, index) {
              ...
              if (index === 0) {
                ...
                newDate.setSeconds(
                  seconds - parseInt(options.secondStep, 10) * value
                );
              }
            ...
            $timepicker.$onKeyDown = function (evt) {
              ...
              var isMeridian =
                (selectedIndex === 2 && !showSeconds) ||
                (selectedIndex === 3 && showSeconds);
              if (selectedIndex === 0) {
                ...
                newDate.setMinutes(
                  minutes + incr * parseInt(options.minuteStep, 10)
                );
                minutesLength = formatDate(newDate, minutesFormat).length;
                selectRange = [hoursLength + sepLength, minutesLength];
              } else if (isSeconds) {
                newDate.setSeconds(
                  seconds + incr * parseInt(options.secondStep, 10)
                );
                secondsLength = formatDate(newDate, secondsFormat).length;
                selectRange = [
                  hoursLength + sepLength + minutesLength + sepLength,
                  secondsLength,
                ];
              } else if (isMeridian) {
                ...
                selectRange = [
                  hoursLength +
                    ...
                    minutesLength +
                    sepLength +
                    (secondsLength + sepLength) * showSeconds,
                  2,
                ];
              }
          ...
          link: function postLink(scope, element, attr, controller) {
            ...
            angular.forEach(["minTime", "maxTime"], function (key) {
              angular.isDefined(attr[key]) &&
                attr.$observe(key, function (newValue) {
                  timepicker.$options[key] = dateParser.getTimeForAttribute(
                    key,
                    newValue
                  );
            ...
            function validateAgainstMinMaxTime(parsedTime) {
              ...
              var isMinValid =
                ...
                new Date(parsedTime.getTime()).setFullYear(1970, 0, 1) >=
                  options.minTime;
              var isMaxValid =
            ...
            controller.$parsers.unshift(function (viewValue) {
              ...
              if (options.timeType === "string") {
                date = dateParser.timezoneOffsetAdjust(
                  parsedTime,
                  options.timezone,
                  true
                );
            ...
            controller.$formatters.push(function (modelValue) {
              ...
              controller.$dateValue = dateParser.timezoneOffsetAdjust(
                date,
                options.timezone
              );
    ...
    .provider("$tab", function () {
      ...
      var controller = (this.controller = function ($scope, $element, $attrs) {
        ...
        self.$isActive = $scope.$isActive = function ($pane, $index) {
          return (
            self.$panes.$active === $pane.name || self.$panes.$active === $index
          );
        };
      });
      this.$get = function () {
        ...
        return {
          ...
          link: function postLink(scope, element, attrs, controllers) {
            ...
            function render() {
              ...
              $animate[
                bsTabsCtrl.$isActive(scope, index) ? "addClass" : "removeClass"
              ](element, bsTabsCtrl.$options.activeClass);
            }
            bsTabsCtrl.$activePaneChangeListeners.push(function () {
              render();
            });
            ...
            $modal.show = function () {
              ...
              if (angular.isElement(options.container)) {
                ...
                after = options.container[0].lastChild
                  ? angular.element(options.container[0].lastChild)
                  : null;
              } else {
                if (options.container) {
                  parent = findElement(options.container);
                  after =
                    parent[0] && parent[0].lastChild
              ...
              modalElement = $modal.$element = compileData.link(
                modalScope,
                function (clonedElement, scope) {}
              );
              if (
              ...
              if (angular.version.minor <= 2) {
                ...
                $animate
                  .enter(modalElement, parent, after)
                  .then(enterAnimateCallback);
              }
            ...
            $parseOptions.valuesFn = function (scope, controller) {
              return $q
                ...
                .then(function (values) {
                  ...
                  $parseOptions.$values = values.length
        ...
        this.$get = [
          ...
          function ($locale, dateFilter) {
            var DateParserFactory = function (config) {
              ...
              $dateParser.timezoneOffsetAdjust = function (
                date,
                timezone,
                undo
              ) {
                ...
                if (timezone && timezone === "UTC") {
                  ...
                  date.setMinutes(
                    date.getMinutes() +
                      (undo ? -1 : 1) * date.getTimezoneOffset()
                  );
                }
                return date;
              };
        ...
        return {
          ...
          link: function link(scope) {
            ...
            if (controller) {
              ...
              var ctrl = angular.isObject(invokeCtrl)
                ? invokeCtrl
                : invokeCtrl();
        ...
        return {
          ...
          link: function postLink(scope, element, attr, controller) {
            ...
            angular.forEach(["minDate", "maxDate"], function (key) {
              angular.isDefined(attr[key]) &&
                attr.$observe(key, function (newValue) {
                  datepicker.$options[key] = dateParser.getDateForAttribute(
                    key,
                    newValue
                  );
        ...
        function ($dateFormatter, $dateParser, $sce) {
          return function (picker) {
            ...
            var startDate =
              picker.$date ||
              (options.startDate
                ? dateParser.getDateForAttribute("startDate", options.startDate)
                : new Date());
            var viewDate = {
            ...
            var views = [
              {
                ...
                build: function () {
                  ...
                  var today = dateParser
                    .timezoneOffsetAdjust(new Date(), options.timezone)
                    .toDateString();
                  if (firstDateOffset !== firstDayOfMonthOffset)
                    firstDate = new Date(
                      +firstDate +
                        (firstDateOffset - firstDayOfMonthOffset) * 6e4
                    );
                  var days = [],
                    day;
                  for (var i = 0; i < 42; i++) {
                  ...
                  scope.title = formatDate(
                    firstDayOfMonth,
                    options.monthTitleFormat
                  );
                ...
                isDisabled: function (date) {
                  ...
                  if (options.disabledDateRanges) {
                    for (
                      ...
                      if (
                        time >= options.disabledDateRanges[i].start &&
                        time <= options.disabledDateRanges[i].end
                      ) {
                        return true;
                      }
                    }
    ...
    .provider("$collapse", function () {
      ...
      var controller = (this.controller = function ($scope, $element, $attrs) {
        ...
        angular.forEach(
          ...
          function (key) {
            if (
              angular.isDefined($attrs[key]) &&
              falseValueRegExp.test($attrs[key])
            ) {
        ...
        link: function postLink(scope, element, attrs, controllers) {
          ...
          element.on("click", function () {
            var index =
              ...
              attrs.bsCollapseToggle !== "bs-collapse-toggle"
                ? attrs.bsCollapseToggle

...
const sourceKey = "dyn-res/property/image/";
        ...
        .then(async (data) => {
          ...
          for (const doc of data) {
            if (data_.includes(doc.Key)) {
              ...
              count++;
              console.log("A B S E N T", doc.Key, data_.indexOf(doc.Key), data_[0]);
              console.log("+++++++=");
              console.log(doc);
              ...
              if (filename !== "") {
                let s3Params = {
                  ...
                  Key: "dyn-res/property/image/" + filename,
                };
                await s3
                  .getObject(s3Params)
                  .promise()
                  .then(async (data) => {
                    ...
                    await convertToWebp(
                      ...
                      .catch(async (err) => {
                        ...
                        var params = {
                          ACL: "public-read",
                          Body: fs.createReadStream(`./property/${filename}`),
                          Bucket: "assetzilla-bucket",
                          Key: `dyn-res/property/image/${filename}`,
                        };
                        await s3

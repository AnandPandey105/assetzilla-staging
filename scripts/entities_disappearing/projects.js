const ENTITY = require("../../models/project.model");

const getNewUrl = (doc) => {
  let url = "";
  url = "/projects/" + slugify(doc.name, slugifyOptions) + "-" + doc.id;
  return url;
};
...
const seedDb = async () => {
  let answer = readline.question(
    "Did you run property.js and property_project_url.js before running this?[y/n]"
  );
  if (answer.toLowerCase() === "n") {
    console.log("Please run them first and then run this");
    return;
  } else {
